...
final class CsrfTest extends TestCase
{
	...
	public function testCsrfTokenCreatesToken(): void
	{
		...
		self::assertSame($token, $this->session->get('celema_csrf_tokens')['default']);
	}
	...
	{
		$csrf = new Csrf($this->session);
		$this->session->set('celema_csrf_tokens', 'invalid');
	...
	public function testCsrfRemoveDeletesToken(): void
	{
		...
		self::assertArrayNotHasKey('albums', $this->session->get('celema_csrf_tokens'));
	}
	...
	public function testCsrfVerifyEmptySession(): void
	{
		...
		$_SERVER['HTTP_X_CSRF_TOKEN'] = $token;
		$_SESSION['celema_csrf_tokens']['default'] = '';
	...
	public function testCsrfVerifyDoesNotCreateToken(): void
	{
		...
		self::assertArrayNotHasKey('missing', $_SESSION['celema_csrf_tokens']);
	}
